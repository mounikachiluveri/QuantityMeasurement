...
public class QuantityMeasurementTest {
    ...
    @Test
    public void given1TonneAnd1000Kilograms_IfEqual_ShouldReturnTrue() {
    ...
    @Test
    public void given1TonneAnd999Kilograms_IfNotEqual_ShouldReturnFalse() {
        double tonne1 = quantityMeasurement.calculateUnit(UnitType.TONNE, 1.0);
    ...
    @Test
    public void given1TonneAnd1000Grams_WhenAddedEqualTo1001Kilograms_ShouldTrue() {
        double tonne1 = quantityMeasurement.calculateUnit(UnitType.TONNE, 1.0);
